...
const NavbarWithSidebar = () => {
    return (<>
                ...
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Joined</span>
                    ...
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">New File</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div className="h-[90vh]  sm:ml-44 overflow-y-scroll overflow-x-hidden border border-black  mt-16 rounded-md mx-2 relative ">
            <div className="p-4 h-10  dark:border-gray-700 flex items-center justify-between bg-cyan-200 w-full " >
            ...
            <div className=" h-[85.3vh] border-2 border-gray-200  dark:border-gray-700  ">
